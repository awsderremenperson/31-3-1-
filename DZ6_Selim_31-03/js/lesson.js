...
//         btnPrew = document.querySelector('#btn-prev'),
...
//             card.innerHTML =`
//                 <p>${data.title}</p>
//                 <p style="color: ${data.comleted ? "green" : "red"}">${data.complete}</p>
//                 <span>${data.id}</span> `
//             })
// }
//
...
//     function loadCard(cardNumber) {
//
//         cardContent.textContent = `Содержимое карточки номер ${cardNumber}`;
//     }
//
//     function showNextCard() {
//         currentCard = (currentCard % totalCards) + 1;
